...
namespace StudentsFormsApp {
    ...
    public partial class MyDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(string FirstName, string LastName, string Address, string Class, string Section, string FatherName, string MotherName, string RollNumber) {
...
namespace StudentsFormsApp.MyDatabaseDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Students] ([FirstName], [LastName], [Address], [Class], [Section], [FatherName], [MotherName], [RollNumber]) VALUES (@FirstName, @LastName, @Address, @Class, @Section, @FatherName, @MotherName, @RollNumber);
SELECT StudentID, FirstName, LastName, Address, Class, Section, FatherName, MotherName, RollNumber FROM Students WHERE (StudentID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [FirstName] = @FirstName, [LastName] = @LastName, [Address] = @Address, [Class] = @Class, [Section] = @Section, [FatherName] = @FatherName, [MotherName] = @MotherName, [RollNumber] = @RollNumber WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Class = 1 AND [Class] IS NULL) OR ([Class] = @Original_Class)) AND ((@IsNull_Section = 1 AND [Section] IS NULL) OR ([Section] = @Original_Section)) AND ([RollNumber] = @Original_RollNumber));
SELECT StudentID, FirstName, LastName, Address, Class, Section, FatherName, MotherName, RollNumber FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentsFormsApp.Properties.Settings.Default.MyDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, FirstName, LastName, Address, Class, Section, FatherName, Mothe" +
                "rName, RollNumber FROM dbo.Students";
        ...
        public virtual int Delete(int Original_StudentID, string Original_FirstName, string Original_LastName, string Original_Class, string Original_Section, string Original_RollNumber) {
            ...
            if ((Original_RollNumber == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_RollNumber));
            }
        ...
        public virtual int Insert(string FirstName, string LastName, string Address, string Class, string Section, string FatherName, string MotherName, string RollNumber) {
            if ((FirstName == null)) {
            ...
            if ((RollNumber == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[7].Value = ((string)(RollNumber));
            }
        ...
        public virtual int Update(string FirstName, string LastName, string Address, string Class, string Section, string FatherName, string MotherName, string RollNumber, int Original_StudentID, string Original_FirstName, string Original_LastName, string Original_Class, string Original_Section, string Original_RollNumber, int StudentID) {
            if ((FirstName == null)) {
            ...
            if ((RollNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(RollNumber));
            }
            ...
            if ((Original_RollNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_RollNumber));
            }
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Address, string Class, string Section, string FatherName, string MotherName, string RollNumber, int Original_StudentID, string Original_FirstName, string Original_LastName, string Original_Class, string Original_Section, string Original_RollNumber) {
            return this.Update(FirstName, LastName, Address, Class, Section, FatherName, MotherName, RollNumber, Original_StudentID, Original_FirstName, Original_LastName, Original_Class, Original_Section, Original_RollNumber, Original_StudentID);
        }
    }
